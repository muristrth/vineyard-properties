  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-gray-50 to-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-2">
              <Badge variant="secondary" className="text-sm px-4 py-2 bg-red-50 text-red-700 border-red-200">
            ...
            <div className="pt-6">
              <div className="flex items-baseline space-x-2">
                <span className="text-4xl font-radio-canada font-bold text-gray-900">$4,750,000</span>
                <span className="text-lg text-gray-500">For selling price</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-slide-up">
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                <img
                  src="https://ext.same-assets.com/2009473017/1082928151.svg"
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg p-4 border border-gray-100">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">360° Virtual Tour</span>
                </div>
              </div>
              ...
              <div className="absolute -top-4 -right-4 bg-white rounded-xl shadow-lg p-4 border border-gray-100">
                <div className="text-center">
                  ...
                  <p className="font-bold text-lg text-gray-900">$4.7M</p>
                </div>
              </div>
            </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 hidden lg:block">
        <div className="flex items-center space-x-1 bg-white/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-gray-100">
          <span className="text-sm text-gray-600">Categories:</span>
          <div className="flex space-x-4">
            <Badge variant="secondary" className="text-xs bg-red-50 text-red-700">Luxury Villas</Badge>
            <Badge variant="secondary" className="text-xs bg-red-50 text-red-700">Modern Homes</Badge>
            <Badge variant="secondary" className="text-xs bg-red-50 text-red-700">Waterfront</Badge>
          </div>
        </div>
      </div>
    </section>
